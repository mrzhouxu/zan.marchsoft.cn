<template>
  <div>
     <mt-header title="规则说明"></mt-header>
      ...
      <div>
        ...
        <div class="rule-desc"> 
          ...
          <p><span>特别说明：</span>兑换（假期）时需首先对组长说明，组长向考勤等相关负责人说明，并在当晚将点赞币交给相关负责人</p>
        </div>
      </div>
  </div>
</template>
...
<style scoped>
  .back {
    ...
    .apply-bg {
        ...
        height: 150px;
        background: url(../../../assets/img/rule-desc.png) no-repeat center center;
